...
// MARK: - GetSecurityQuestionElement

class SecurityQuestionElement: Codable {
    let id, question, created: String

    init(id: String, question: String, created: String) {
        self.id = id
...
var securityQuestion : [SecurityQuestionElement] = []
