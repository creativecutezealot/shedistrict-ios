...
//    @IBOutlet weak var img_cancel:UIImageView!
    ...
    @IBOutlet weak var lblChooseCamera:UILabel!
...
//            height_camera_view.constant = 200 //view_selected_image.bounds.width
...
//        img_cancel.isHidden = true
        img_selected.image = UIImage (named:"Model.png")
    ...
    @IBAction func btnTypeOfVerification(_ sender:UIButton) {
...
//        height_camera_view.constant = 200 //view_selected_image.bounds.width
        ...
        if lblChooseCamera.text! == "Open Camera" {
            lblChooseCamera.text! = "Click Photo"
            previewLayer?.isHidden = false
//            self.img_selected.isHidden = true
        } else if lblChooseCamera.text! == "Click Photo" {
            lblChooseCamera.text! = "Retake Photo"
            cameraDidTap(sender)
        } else if lblChooseCamera.text! == "Retake Photo" {
            lblChooseCamera.text! = "Click Photo"
            previewLayer?.isHidden = false
//            self.img_selected.isHidden = true
        }
